...
const COPY = {
  en: {
    headlineHasProjects: "Pick a project from the sidebar to start working",
    headlineNoProjects: "Welcome to QuadWork — let's set up your first AI dev team",
    subtextHasProjects: "Each project has its own 4-agent team and chat. Click any chip in the left sidebar to open one.",
...
export default function HomeEmptyState({ hasProjects }: HomeEmptyStateProps) {
  ...
  const headline = hasProjects ? t.headlineHasProjects : t.headlineNoProjects;
  const subtext = hasProjects ? t.subtextHasProjects : t.subtextNoProjects;
